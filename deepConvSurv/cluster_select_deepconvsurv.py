...
if __name__ == '__main__':
    ...
    root_path = 'D:\pycharm\WSISA-main\cluster_result\patches_1000_cls10'
    for i in range(4,7):
        print('======================================================')
        print('======================================================')
        print('=================      cluster  %d      ==============' %i)
        ...
        model_selection(img_path='D:\pycharm\WSISA-main\WSISA\patches\TCGA-BL-A3JM',
                        #clinical_path = '/smile/nfs/nlst-patch_1000/clinicalNormalized.csv',
                        label_path = 'D:\pycharm\WSISA-main\deepConvSurv\patients.csv',
