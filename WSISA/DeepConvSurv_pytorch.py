...
class DeepConvSurv:
    def __init__(self, learning_rate, channel, width, height, lr_decay=0.01, momentum=0.9, L2_reg=0.0, L1_reg=0.0,
                 standardize=False):
    ...
    def train(self, data_path, label_path, train_index, test_index, valid_index,
              model_index=0, cluster=0, num_epochs=5, batch_size=10, validation_frequency=30, patience=500,
              improvement_threshold=0.995, patience_increase=1.2, verbose=True, ratio=0.8,
